defmodule DoubleEntryLedger.Workers.CommandWorker.UpdateTransactionEventMapNoSaveOnError do
  @moduledoc """
  ...
  defdelegate handle_occ_final_timeout(event_map, repo),
    to: Workers.CommandWorker.CreateTransactionEventMapNoSaveOnError,
