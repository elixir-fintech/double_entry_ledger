defmodule DoubleEntryLedger.Workers.CommandWorker.AccountEventMapResponseHandler do
  @moduledoc """
  ...
  * **Changeset Propagation**: Ensures validation errors are properly propagated to calling code
  ...
  This module is typically used by CommandWorker modules that process AccountEventMap
