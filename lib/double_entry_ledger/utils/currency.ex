defmodule DoubleEntryLedger.Utils.Currency do
  @moduledoc """
  ...
  """
  @spec to_abs_money(integer(), currency_atom() | binary()) :: Money.t() | {:error, String.t()}
  def to_abs_money(amount, currency) when is_integer(amount) do
    to_money(abs(amount), currency)
  end
