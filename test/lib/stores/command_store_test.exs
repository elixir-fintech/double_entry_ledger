defmodule DoubleEntryLedger.Stores.CommandStoreTest do
  ...
  alias DoubleEntryLedger.{Command, CommandQueueItem, Repo, PendingTransactionLookup}
  ...
  describe "create/1" do
    ...
    test "reads command insertion timestamps generated by the database", %{instance: instance} do
      ...
      assert %DateTime{} = initial_updated_at = command.command_queue_item.updated_at
      ...
      assert DateTime.after?(updated_queue_item.updated_at, initial_updated_at)
    end
